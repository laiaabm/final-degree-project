"""
This script is directly sourced from the TRIDENT repository by Mahmood Lab:
https://github.com/mahmoodlab/TRIDENT/blob/main/trident/Visualization.py

The code is used to visualize attention heatmaps on Whole Slide Images (WSIs).
"""
...
def visualize_heatmap(
    ...
    output_heatmap: Optional[str] = "heatmap.png"
) -> str:
    """
    ...
    Args:
        ...
        output_heatmap (Optional[str]): Name of the output heatmap image.
